...
Experience Platform's [!UICONTROL Query Service] allows SQL queries to be performed on the data. The Data Science Workspace enables data exploration, data science, and machine learning workloads to be performed on the data. 
...
1.  Ingest data.
1.  Confirm that data is available to [!UICONTROL Query Service] and Data Science Workspace for raw access and query.
